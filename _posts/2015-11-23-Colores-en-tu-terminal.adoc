...
Para seleccionar colores en esta paleta puedes utilizar la heramiento online link:http://www.w3schools.com/tags/ref_colorpicker.asp[HTML Color Picker] de link:http://www.w3schools.com/[W3Schools].
