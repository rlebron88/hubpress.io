...
El siguiente ejemplo muestra como convertir a FASTQ en paralelo tantos ficheros SRA como hilos tenga la CPU, quedando el resto de ficheros en cola. Cuando una conversión termina queda un hilo libre, que es automáticamente ocupado por otra siempre que haya ficheros en cola. 
