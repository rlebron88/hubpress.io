...
Los comandos *_cp_*, *_mv_*, *_rm_*, *_rmdir_*, *_cat_*, *_more_*, *_less_*, *_ls_*, *_locate_* y *_find_* se pueden utilizar sobre todos los ficheros, excepto los que se indiquen:
